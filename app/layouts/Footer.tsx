    ...
    <footer className="w-full">
      ...
      <div className="bg-[#2f3637] text-white">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 py-4">
          {/* Quote */}
          <p className="mx-auto max-w-2xl text-center text-sm sm:text-base leading-7 sm:leading-8">
          ...
          {/* Divider */}
          <div className="mx-auto mt-8 sm:mt-10 h-px w-full bg-white/30" />

          {/* Social Icons */}
          <div className="mt-6 sm:mt-7 flex items-center justify-center gap-5 sm:gap-7">
            <a
              href="#"
      ...
      {/* Bottom Bar */}
      <div className="bg-[#3b3939] py-4 px-4">
